...
- Better text visibility and spacing for Kaomoji
...
[
  {
    "char": "😀",
    "tags": ["grin", "smile", "happy", "기쁨", "웃음", "행복"]
  },
  {
    "char": "😂",
    "tags": ["laugh", "joy", "tears", "웃음", "눈물", "재밌어"]
  }
]
```
...
- `char` _(string)_: 이모지 문자
- `tags` _(string[])_: 검색 태그 (한글/영문 혼용 가능)
...
[
  {
    "char": "(ᵔᵕᵔ)",
    "tags": ["기쁨", "웃음", "스마일", "smile", "happy", "cute"]
  },
  {
    "char": "(╥﹏╥)",
    "tags": ["슬픔", "눈물", "울음", "sad", "cry", "tears"]
  }
]
```
...
- `char` _(string)_: 카오모지 문자열
- `tags` _(string[])_: 검색 태그 및 카테고리 (첫 번째 태그가 주 카테고리)
